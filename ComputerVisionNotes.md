...
| ------------------------------------------------------------ | --------------------------------------- | --------- | --------- |
| 【Apollo】百度阿波罗 | [阿波罗学习笔记](https://github.com/daohu527/dig-into-apollo)<br>[Dig into Apollo教程](https://dig-into-apollo.readthedocs.io/en/latest/index.html#)<br>[阿波罗智能驾驶入门课程](https://developer.apollo.auto/devcenter/coursetable_cn.html?target=1)<br>[阿波罗自动驾驶培训中心](https://developer.apollo.auto/devcenter/idpcourse_cn.html)<br> | []() | [源码](https://github.com/ApolloAuto/apollo)<br>[自动驾驶仿真环境lgsvl](https://github.com/lgsvl/simulator)<br> |
| 【OpenMMLab】开源计算机视觉算法系统 | [MMTracking中文文档](https://mmtracking.readthedocs.io/zh_CN/latest/#)<br>[MMDetection中文文档](https://mmdetection.readthedocs.io/zh_CN/latest/)<br>[MMDetection3D中文文档](https://mmdetection3d.readthedocs.io/zh_CN/latest/)<br>[MMSegmentation中文文档](https://mmsegmentation.readthedocs.io/zh_CN/latest/index.html)<br>[OpenMMLab知乎专区](https://www.zhihu.com/people/openmmlab)<br>[B站教程](https://space.bilibili.com/1293512903?from=search&seid=11928695278981035191)<br> | []() | [源码](https://github.com/open-mmlab)<br> |
## 计算机视觉——实战小项目
...
| 经典论文                                                         | 原理总结                         | 论文    | 代码(GitHub)    |
| ------------------------------------------------------------ | --------------------------------------- | --------- | --------- |
| Alexnet-R-10W+ | []() | [ImageNet Classification with Deep Convolutional Neural Networks](https://proceedings.neurips.cc/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf) | []() |
| VGGnet-R-7W+ | []() | [Very Deep Convolutional Networks for Large-Scale Image Recognition](https://arxiv.org/pdf/1409.1556.pdf%E3%80%82) | []() |
| LenetV1-R-4W+ | []() | [Going deeper with convolutions](https://www.cv-foundation.org/openaccess/content_cvpr_2015/papers/Szegedy_Going_Deeper_With_2015_CVPR_paper.pdf) | []() |
| LenetV2-R-4W+ | []() | [Batch Normalization: Accelerating Deep Network Training by Reducing Internal Covariate Shift](http://proceedings.mlr.press/v37/ioffe15.pdf) | []() |
| LenetV3-R-2W+ | []() | [Rethinking the Inception Architecture for Computer Vision](https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/Szegedy_Rethinking_the_Inception_CVPR_2016_paper.pdf) | []() |
| Resnet-R-11W+ | []() | [Deep Residual Learning for Image Recognition](https://openaccess.thecvf.com/content_cvpr_2016/papers/He_Deep_Residual_Learning_CVPR_2016_paper.pdf) | []() |
| LenetV4-R-1W+ | []() | [Inception-ResNet and the Impact of Residual Connections on Learning](https://www.aaai.org/ocs/index.php/AAAI/AAAI17/paper/viewFile/14806/14311) | []() |
| ResNeXt-R-1W+ | []() | [Aggregated Residual Transformations for Deep Neural Networks](https://openaccess.thecvf.com/content_cvpr_2017/papers/Xie_Aggregated_Residual_Transformations_CVPR_2017_paper.pdf) | []() |
| Densenet-R-2W+ | []() | [Densely Connected Convolutional Networks](https://openaccess.thecvf.com/content_cvpr_2017/papers/Huang_Densely_Connected_Convolutional_CVPR_2017_paper.pdf) | []() |
| SEnet-R-1W+ | []() | [Squeeze-and-Excitation Networks](https://openaccess.thecvf.com/content_cvpr_2018/papers/Hu_Squeeze-and-Excitation_Networks_CVPR_2018_paper.pdf) | []() |
| xxx | []() | []() | []() |
...
* [计算机视觉大牛-rbg论文代码集](https://scholar.google.com/citations?hl=en&user=W8VIEZgAAAAJ&pagesize=1000&sortby=pubdate)<br>
## 初级计算机视觉——图像处理
* 图像基本属性
* 图像相似性变换
* 图像仿射变换
...
| YOLO V1 | [1、中文教程(深入理解)](https://zhuanlan.zhihu.com/p/46691043)<br>[2、中文教程(图解YOLO)](https://zhuanlan.zhihu.com/p/24916786)<br>[3、中文教程(YOLO原理与实现)](https://zhuanlan.zhihu.com/p/32525231)<br>[4、YOLO算法详解](https://www.cnblogs.com/zyly/p/9274472.html)<br>[5、yolo源码解析](https://www.cnblogs.com/zyly/p/9534063.html)<br> | [You Only Look Once:Unified, Real-Time Object Detection](https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/Redmon_You_Only_Look_CVPR_2016_paper.pdf) | [源码](https://pjreddie.com/darknet/yolov1/?utm_source=catalyzex.com)<br>[TensorFlow代码1](https://github.com/gliese581gg/YOLO_tensorflow)<br>[TensorFlow代码2](https://github.com/thtrieu/darkflow) |
| YOLO V2（Anchor引入） | [1、中文教程(深入理解)](https://zhuanlan.zhihu.com/p/47575929) | [YOLO9000: Better, Faster, Stronger](https://openaccess.thecvf.com/content_cvpr_2017/papers/Redmon_YOLO9000_Better_Faster_CVPR_2017_paper.pdf) | [PyTorch代码](https://github.com/longcw/yolo2-pytorch)<br> |
...
| Faster RCNN（RPN网络和Anchor） | [1、一文读懂Faster RCNN](https://zhuanlan.zhihu.com/p/31426458)<br>[2、Faster R-CNN算法详解](https://www.cnblogs.com/zyly/p/9247863.html)<br> | [Faster r-cnn Towards real-time object detection with region proposal networks](https://proceedings.neurips.cc/paper/2015/file/14bfa6bb14875e45bba028a21ed38046-Paper.pdf) | [1、源码](https://github.com/ShaoqingRen/faster_rcnn)<br>[2、Pytorch代码1](https://github.com/longcw/faster_rcnn_pytorch)<br>[3、Pytorch代码2](https://github.com/jwyang/faster-rcnn.pytorch)<br> |
...
| 跟踪评价经典方案MOT Metrics | []() | [Evaluating Multiple Object Tracking Performance:The CLEAR MOT Metrics](https://link.springer.com/content/pdf/10.1155/2008/246309.pdf) | [MOT Metrics](https://github.com/cheind/py-motmetrics#References) <br>[CLEAR-MOT](https://github.com/glisanti/CLEAR-MOT)<br> [Official MOTChallenge Evaluation Kit](https://github.com/dendorferpatrick/MOTChallengeEvalKit)<br>|
| xxx | []() | []() | []() |
* 经典目标跟踪方法
  * 帧差法
  * TLD算法
